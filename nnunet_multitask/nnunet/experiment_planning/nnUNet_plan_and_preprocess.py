...
def main():
    ...
    parser.add_argument("-tl", type=int, required=False, default=os.cpu_count(),
                        help="Number of processes used for preprocessing the low resolution data for the 3D low "
                             ...
                             "RAM")
    parser.add_argument("-tf", type=int, required=False, default=os.cpu_count(),
    ...
    # parser.add_argument("--triple_plane", required=False, default=False, action="store_true")
    parser.add_argument("-target_plane", type=str, default=None, required=False)
    ...
    target_plane = args.target_plane
    # triple_plane = args.triple_plane
    ...
    for t in tasks:
        ...
        if planner_2d is not None:
            ...
            # exp_planner.plan_experiment()
            exp_planner.plan_experiment(target_plane)
            # exp_planner.plan_experiment(triple_plane)
            if not dont_run_preprocessing:  # double negative, yooo
                exp_planner.run_preprocessing(threads)
